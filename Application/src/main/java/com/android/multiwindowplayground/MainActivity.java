...
import com.android.multiwindowplayground.activities.MainActivityDragInOneApp;
import com.android.multiwindowplayground.activities.MainActivityDragbetweenApps;
...
public class MainActivity extends LoggingActivity {
    ...
    public void onStartMultiDragActivity(View view) {
        Log.d(mLogTag, "** starting onStartMultiDragActivity");
        startActivity(new Intent(this, MainActivityDragInOneApp.class));
    }


    public void onStartMultiDragActivityBetweenApps(View view) {
        Log.d(mLogTag, "** starting onStartMultiDragActivityBetweenApps");
        startActivity(new Intent(this, MainActivityDragbetweenApps.class));
    }
}
